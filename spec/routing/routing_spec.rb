...
RSpec.describe "routes", type: :routing do
  describe "root path", type: :routing do
  ...
  describe "AreasController", type: :routing do
  ...
  describe "SquaresController", type: :routing do
  ...
  describe "PailsController", type: :routing do
  ...
  describe "FindsController", type: :routing do
  ...
  describe "LociController", type: :routing do
  ...
  describe "RegistrarController", type: :routing do
  ...
  describe "BulkUploadsController", type: :routing do
