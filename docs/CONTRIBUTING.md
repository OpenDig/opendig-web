...
**All pull requests will be approved by [Matthew Vincent](https://github.com/neshmi).**
- Github: https://github.com/neshmi
- Email: matthew@rekrei.org
- Website: https://rekrei.org
...
CONTRIBUTING.md is a modified version of the [TankController CONTRIBUTING.md](https://github.com/Open-Acidification/TankController/blob/main/CONTRIBUTING.md).